...
var getEvent = async ({browser, id, wait}) => {
  ...
  var event = await page.evaluate((id) => ({
    ...
    cover_desktop: document.querySelector('#event_header_primary img').getAttribute('src'),
    // TODO: resize with imagemagick
    cover_mobile: document.querySelector('#event_header_primary img').getAttribute('src'),
